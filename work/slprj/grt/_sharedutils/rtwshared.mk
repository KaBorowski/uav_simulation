...
## Generated on : Tue Apr 05 22:11:15 2022
...
SRCS = $(START_DIR)/slprj/grt/_sharedutils/const_params.c $(START_DIR)/slprj/grt/_sharedutils/rtGetInf.c $(START_DIR)/slprj/grt/_sharedutils/rtGetNaN.c $(START_DIR)/slprj/grt/_sharedutils/rt_nonfinite.c $(START_DIR)/slprj/grt/_sharedutils/rt_powf_snf.c
...
OBJS = const_params.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_powf_snf.obj
...
const_params.obj : $(START_DIR)/slprj/grt/_sharedutils/const_params.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
rt_powf_snf.obj : $(START_DIR)/slprj/grt/_sharedutils/rt_powf_snf.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
